...
Route::any('/route_create', 'Laravelroles\Rolespermissions\Controllers\RouteController@routeCreate')->name('route_create');
...
Route::get('/route_delete/{routeId}', 'Laravelroles\Rolespermissions\Controllers\RouteController@routeDelete')->name('route_delete');
 ...
 Route::get('/user_create', 'Laravelroles\Rolespermissions\Controllers\UserController@userCreate')->name('user_create');
